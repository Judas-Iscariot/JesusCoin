...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        "  -?                     " + _("This help message") + "\n" +
        "  -conf=<file>           " + _("Specify configuration file (default: jesuscoin.conf)") + "\n" +
        "  -pid=<file>            " + _("Specify pid file (default: jesuscoind.pid)") + "\n" +
        ...
        "\n" + _("SSL options: (see the Jesuscoin Wiki for SSL setup instructions)") + "\n" +
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    if (!lock.try_lock())
        return InitError(strprintf(_("Cannot obtain a lock on data directory %s. Jesuscoin is probably already running."), strDataDir.c_str()));

    if (GetBoolArg("-shrinkdebugfile", !fDebug))
        ShrinkDebugFile();
    printf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    printf("Jesuscoin version %s (%s)\n", FormatFullVersion().c_str(), CLIENT_DATE.c_str());

...
static const char *strMainNetDNSSeed[][2] = {
    {"jesuscointools.com", "dnsseed.jesuscointools.com"},
    {"jesuscoinpool.org", "dnsseed.jesuscoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"jesuscointools.com", "testnet-seed.jesuscointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Jesuscoin is probably already running."), addrBind.ToString().c_str());
        else
